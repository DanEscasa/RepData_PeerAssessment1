...
As an aside, take note of the use of the superassignment (`<<-`) instead of the usual assignment operator (`<-`). This is because the `with(){}` creates its own scope. And yes, the scope applies to assigning `colnames()`.
```{r echo = TRUE}
with(data = activity,{
